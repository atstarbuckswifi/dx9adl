...
def renderD3DItems(pIS):
  ...
  if q.stat & 0x00008000:
    ...
    BltTexture(pIS, 0xFFFFFFFF, PtrPtrU(pIS, TXSRC), 0, 0, 256, 256,
      c_double(0.), c_double(0.), c_double(0.),
      c_double(10.), c_double(100.), c_double(1.))
...
def main():
  debugout('adl_test_vtx\n')
  istat = RenderD3DItemsState(0, 0, 0, 0, 0, 0,
    800, 450, 0x80EECC33, 0xCC99CCFF,
    0x0CC00000, 0, 0, 0, 0, 0)
  hInst = ctypes.windll.kernel32.GetModuleHandleA(0)
  nShow = 1 # 1: SW_SHOWNORMAL or 5: SW_SHOW
  className = ctypes.create_string_buffer('clsDx9ADLtest_vtx')
  appName = ctypes.create_string_buffer('appDx9ADLtest_vtx')
